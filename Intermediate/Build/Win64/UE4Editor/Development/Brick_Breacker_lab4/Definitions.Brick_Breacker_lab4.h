...
#define UE_PROJECT_NAME Brick_Breacker_lab4
#define UE_TARGET_NAME Brick_Breacker_lab4Editor
#define UE_MODULE_NAME "Brick_Breacker_lab4"
...
#define BRICK_BREACKER_LAB4_API DLLEXPORT
